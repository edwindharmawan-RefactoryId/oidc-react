...
exports.AuthProvider = function (_a) {
    ...
    var _e = react_1.useState({
        status: false,
        message: "",
    }), isError = _e[0], setIsError = _e[1];
    var _f = react_1.useState(null), userData = _f[0], setUserData = _f[1];
    ...
    react_1.useEffect(function () {
        var getUser = function () { return __awaiter(void 0, void 0, void 0, function () {
            var user_1, error_1, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!exports.hasCodeInUrl(location)) return [3, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        ...
                        setIsError({
                            status: true,
                            message: typeof error_1 === 'string' ? error_1 : "Error coming from oidc react",
                        });
                        return [3, 4];
                    case 4: return [4, userManager.getUser()];
                    case 5:
                        user = _a.sent();
